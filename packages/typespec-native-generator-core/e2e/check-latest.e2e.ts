...
beforeAll(async () => {
  ...
  const filename = files.find((x) => x.startsWith("azure-tools-typespec-native-generator-core-"));
  if (filename === undefined) {
    throw new Error(
      `Cannot resolve package starting with "azure-tools-typespec-native-generator-core-"`
    );
  }
