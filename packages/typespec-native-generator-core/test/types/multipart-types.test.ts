...
describe("typespec-native-generator-core: multipart types", () => {
  ...
  it("multipart conflicting model usage", async function () {
    ...
    expectDiagnostics(runner.context.diagnostics, {
      code: "@azure-tools/typespec-native-generator-core/conflicting-multipart-model-usage",
    });
  });
  ...
  it("multipart with encoding bytes raises error", async function () {
    ...
    expectDiagnostics(runner.context.diagnostics, {
      code: "@azure-tools/typespec-native-generator-core/encoding-multipart-bytes",
    });
  });
