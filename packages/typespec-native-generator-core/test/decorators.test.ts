...
describe("typespec-native-generator-core: decorators", () => {
  ...
  describe("@client", () => {
    ...
    it("emit diagnostic if the client namespace doesn't ends with client", async () => {
      ...
      expectDiagnostics(diagnostics, {
        code: "@azure-tools/typespec-native-generator-core/client-name",
      });
    });
  ...
  describe("@operationGroup", () => {
    ...
    it("@operationGroup with diagnostics", async () => {
      ...
      // java should report disgnostics
      {
        ...
        expectDiagnostics(diagnostics, {
          code: "@azure-tools/typespec-native-generator-core/client-service",
        });
      }
  ...
  describe("client hierarchy", () => {
    ...
    it("rename client name - diagnostics", async () => {
      ...
      expectDiagnostics(diagnostics, {
        code: "@azure-tools/typespec-native-generator-core/wrong-client-decorator",
      });
  ...
  describe("@flattenProperty", () => {
    ...
    it("throws error when used on a polymorphism type", async () => {
      ...
      expectDiagnostics(diagnostics, {
        code: "@azure-tools/typespec-native-generator-core/flatten-polymorphism",
      });
    });
  });
  ...
  describe("@clientName", () => {
    ...
    it("empty client name", async () => {
      ...
      expectDiagnostics(diagnostics, {
        code: "@azure-tools/typespec-native-generator-core/empty-client-name",
      });
    });
    ...
    it("duplicate model client name with a random language scope", async () => {
      ...
      expectDiagnostics(diagnostics, [
        {
          code: "@azure-tools/typespec-native-generator-core/duplicate-client-name",
  ...
  describe("@override", () => {
    ...
    it("params mismatch", async () => {
      ...
      expectDiagnostics(diagnostics, {
        code: "@azure-tools/typespec-native-generator-core/override-method-parameters-mismatch",
      });
    });
